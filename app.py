...
with st.expander("🏢 1단계: 사업장 및 하위 배출시설 조직경계 AI 설정", expanded=not st.session_state["boundary_context"]):
    ...
    |---|---|---|---|
    | (예: 본사) | (예: 영업본부) | (예: 이동연소, 전력) | - |
    | (예: 울산공장) | (예: 1생산팀) | (예: 고정연소, 공정배출) | - |
    
    [매우 중요]
    응답 마지막 줄엔 반드시 아래 형식으로 추출된 '상위 사업장과 하위 부서'를 묶어서 쉼표로 구분해 적어줘!
    형식 예시: WORKPLACE_LIST: [본사] 영업본부, [본사] R&D센터, [울산공장] 1생산팀, [울산공장] 유틸리티팀
    """
